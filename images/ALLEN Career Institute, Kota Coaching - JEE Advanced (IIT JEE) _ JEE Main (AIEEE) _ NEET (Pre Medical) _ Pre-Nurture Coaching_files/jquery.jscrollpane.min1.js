...
function ax(){
    ...
    b("html").unbind("dragstart.jsp");
    b("html").unbind("selectstart.jsp");
    b("html").unbind("mousemove.jsp");
    b("html").unbind("mouseup.jsp");
    b("html").unbind("mouseleave.jsp");
